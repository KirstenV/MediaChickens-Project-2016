                ...
                <div class="row">
                    ...
                    <div id="edit_content">
                        ...
                        <div class="alle_content">
                            <div class="row">
                                ...
                                <div class="col-md-12 no-padding">
                                    ...
                                    <p ng-class="{'invalid': toon_fout_melding('titel',project.id)}"
                                       ...
                                       data-placement="left" title="Klik om aan te passen" data-update_status='init'
                                       data-titel='titel' data-tabel='projecten' data-id='{{$id}}'
                                                ...
                                                <a href="" id="foto-delete" data-toggle="tooltip" data-placement="top"
                                                   title="Verwijder foto">
                                                    <i class="fa fa-times" aria-hidden="true"
                                                       ng-click="delete_elemets_on_edit_page_fotos(foto.id,$index,'foto','show_fotos')"></i>
                                                </a>
                            ...
                            <div class="row col-md-12 no-padding">
                                ...
                                <p ng-class="{'invalid': toon_fout_melding('beschrijving',project.id)}"
                                   ...
                                   data-titel='beschrijving' data-tabel='projecten' data-id='{{$id}}'
                        ...
                        <div id="datepicker">
                            ...
                            <input data-update_status='init' data-titel='begin_datum' data-tabel='projecten'
                                   data-id='{{$id}}' type="text" class="inline  begin_datum datum textbox" name="start"
                                   ng-model="project.begin_datum"/>
                            <div class="col-md-1 pull-right glyphicon glyphicon-saved "
                                 ng-show="toon_succes_melding('begin_datum',project.id)">
                            </div>
                            <div class="col-md-11 invalid"
                                 ng-show="toon_fout_melding('begin_datum',project.id)">@{{ server_controle_fout[0] }}
                            </div>

                            <span class="input-group-addon inline">tot</span>
                            <input data-update_status='init' data-titel='eind_datum' data-tabel='projecten'
                                   data-id='{{$id}}' type="text" class="inline  begin_datum datum textbox" name="end"
                                   ng-model="project.eind_datum"/>
                            <div class="col-md-1 pull-right glyphicon glyphicon-saved "
                                 ng-show="toon_succes_melding('eind_datum',project.id)">
                            </div>
                            <div class="col-md-11 invalid"
                                 ng-show="toon_fout_melding('eind_datum',project.id)">@{{ server_controle_fout[0] }}
                            </div>
                            ...
                            <div ng-repeat="location in locations">
                                <div class="row col-md-12">
                                    ...
                                    <a class="map_delete" href="" title="verwijder">
                                        <i class="fa fa-times inline" aria-hidden="true"
                                           ng-click="delete_elemets_on_edit_page_locatie(location.id,$index,'locations')"></i>
                                    </a>
                                    <br>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12 no-padding">
                            ...
                            <div class="col-md-12 no-padding" ng-repeat="vraag in alle_vragen">
                                <div ng-show="vraag.choices == 'open vragen'">
                                    ...
                                    <h5 class="title_red inline">Vraag @{{ $index }}: @{{vraag.choices}}</h5> <a href=""
                                                                                                                 style="text-decoration:none"
                                                                                                                 title="verwijder"><i
                                                class="fa fa-times inline" aria-hidden="true"
                            ...
                            <div class="vraag_add_button">
                                ...
                                <div class="btn-group " role="group" aria-label="...">
                                    ...
                                    <button type="button" class="btn btn-default mybutton"
                                            ng-click="add_question('open vragen')">open vraag
                                    </button>


                                    <button type="button" class="btn btn-default"
                                            ng-click="add_question('meerkeuzevragen')">meerkeuzevraag
                                    </button>

                                    <button type="button" class="btn btn-default"
                                            ng-click="add_question('Gesloten vragen')">gesloten vraag
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="row col-md-12">
                            ...
                            <br>
                            <div class="all_fases col-md-12 no-padding" ng-controller="add_fase_and_filleController"
                                        ...
                                        <div id="fase-full" class="col-md-12">
                                            <div class="row col-md-6 no-padding">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <a class="inline" style="text-decoration:none" href=""
                                                       id="vragen-delete" data-toggle="tooltip" data-placement="top"
                                                       title="Verwijder foto">
                                                        <i class="fa fa-times inline" aria-hidden="true"
                                                           ng-click="delete_elemets_on_edit_page_fase(fase.id,$index,'fases')"></i>
                                                    </a>
                                                </div>
                                                ...
                                                <div ng-class="{'invalid': toon_fout_melding('fase_beschrijving',fase.id)}"
                                                     class='col-md-11 project titel col-md-10' data-update_status='init'
                                                     data-titel='fase_beschrijving' data-tabel='fases'
                                                     data-id='@{{fase.id}}'
                                            ...
                                            <div id="fase-img" ng-click="get_fase_id($index)"
                                                 class="col-md-6 inline no-padding"
                                                 ngf-select="uploadFiles($files, $invalidFiles, fase.id,$index )"
                                                 accept="image/*" ngf-max-height="1000" ngf-accept="'image/*'"
                                                 ngf-max-size="1MB">
                                                <div id="fase-img-del">
                                                    <a href="" id="fase-delete" data-toggle="tooltip"
                                                       data-placement="top" title="Verwijder foto">
                                                        <i class="fa fa-times" aria-hidden="true"
                                                           ng-click="delete_elemets_on_edit_page_fotos(foto.id,$index,'foto','show_fotos')"></i>
                                                    </a>
                                                    <img ng-src="{{Request::root()}}/img/fase/@{{ fase.fases_picture }}"
