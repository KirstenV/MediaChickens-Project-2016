...
<script type="text/javascript">
	...
	function load() {
		...
		$.ajax({
			url: "http://project.local/antwerpen_project/public/kaart/api/get_locations",
			success: function (data) {
				...
				for (var i = 1; i < data.length; i++) {
					...
					//console.log(j);
					$.ajax({
						url: "http://project.local/antwerpen_project/public/kaart/" + locatie_id + "/api/get_locations",
